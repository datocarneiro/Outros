...
# Abre o arquivo CSV especificado em diretorioPlanilha para leitura 
# (mode='r') e cria um objeto leitor_csv para ler o conteúdo do arquivo no formato de dicionário.
with open(diretorioPlanilha, mode='r') as arquivo_csv:
    ...
    for linha in leitor_csv:
        ...
        ano = linha['Ano']
        #Divide a coluna 'date' em partes separadas por espaço 
        # e pega apenas a segunda parte (representando o mês).
        date = linha['date'].split(' ')[1]
        #Substitui os caracteres '.' por vazio e ',' por '.' na coluna 'amount' 
        # e converte o resultado para um número de ponto flutuante.
...
# Cria duas novas colunas no DataFrame, 'Ano' e 'Mes',
# que correspondem ao ano e mês extraídos da coluna 'Data'.
